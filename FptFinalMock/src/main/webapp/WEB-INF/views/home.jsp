  ...
  <div class="panel panel-success">
	...
	<div class="panel-body">
		 ...
		 <div class="w3-col s3  w3-center">
			<div class="w3-dropdown-hover">
				...
				<div class="w3-dropdown-content w3-border">
					<a href="themnhanvien" target="iframe"><spring:message   code="label.TaoTaiKhoan" /></a>		 
 					<a href="doimatkhau" target="iframe"><spring:message   code="label.DoiMatKhau" /></a>
					<div class="dropdown">
				...
				<div class="w3-dropdown-content w3-border">
					<div class="dropdown">
					 ...
					 <spring:message   code="label.QLTT" /><span class="glyphicon glyphicon-menu-right"></span></button>
					  <div class="dropdown-content">
					    <a href="qlnhanvien"target="iframe"> <spring:message   code="label.TTNV" /></a> 
					     <a href="qlKhachHang" target="iframe"><spring:message   code="label.TTKH" /></a> 
      ...
      <div class="panel-body">
       <!--  Start Body -->
       <div class="well">
	      <iframe src="<%=request.getContextPath() %>/themnhanvien" name="iframe" id="iframe"
